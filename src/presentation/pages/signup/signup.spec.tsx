...
const makeSut = (params?: SutParams): SutTypes => {
  ...
  const sut = render(<Signup validation={validationStub} addAccount={addAccountSpy} saveAccessToken={saveAccessTokenMock} />)
...
const simulateValidSubmit = async (sut: RenderResult, name = faker.name.fullName(), email = faker.internet.email(), password = faker.internet.password()): Promise<void> => {
